...
crime_url = "https://data.lacity.org/api/views/2nrs-mtv8/rows.csv"
weather_url = "https://archive-api.open-meteo.com/v1/archive"


print("Checking for existing merged data...")
if os.path.exists('../vol/data/combined.csv'):
    print("Merged data found, bypassing data fetching...")
    exit()
## Download Crime Data from portal

print("Checking for existing crime data...")
if os.path.exists('../data/crime.csv'):
    print("Crime data found, moving on...")
else:
    print("Fetching crime data from ",crime_url,"...")
    with requests.get(crime_url,stream=True) as r:
        r.raise_for_status()
...
if os.path.exists('../data/weather.csv'):
    print("Weather data found, moving on...")
else:
